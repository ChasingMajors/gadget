...
This creates `dist/cm-rarity-gadget-v4.0.10.zip`. Keep the unpacked extension folder path stable on each tester Mac so Chrome can reload updates without removing/re-adding the extension.
